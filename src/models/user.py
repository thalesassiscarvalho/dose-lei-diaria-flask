...
class User(UserMixin, db.Model):
    ...
    # =====================================================================
    # <<< INÍCIO DA IMPLEMENTAÇÃO: Adicionar campo de concurso padrão >>>
    # =====================================================================
    # Armazena o ID do concurso que o usuário definiu como padrão.
    # É uma chave estrangeira para a tabela 'concurso'.
